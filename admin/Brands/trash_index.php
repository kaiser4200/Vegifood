            ...
            <div class="col-5">
                <table class="table table-bordered">
                    ...
                    if(count($brands) > 0):
                        foreach($brands as $brand):
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="restore.php?id=<?= $brand['id'];?>" onclick="return confirm('Are you sure you want to restore?')">Restore</a>
                        ...
                        ?>
                        <tr>
                            <td colspan="2">No trashed $brand is available. <a href="index.php">Click here to trash one.</a></td>
                        </tr>
                    <?php
                    endif;
                    ?>
