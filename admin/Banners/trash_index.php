                        ...
                        foreach($banners as $banner):
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="delete.php?id=<?= $banner['id'];?>" onclick="return confirm('Are you sure you want to delete?')">Delete</a> |

                                    <a href="restore.php?id=<?= $banner['id'];?>" onclick="return confirm('Are you sure you want to restore?')">Restore</a>
