    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-8">
                <ul class="nav">
                    <li class="nav-item">
                        <a class="nav-link h4" href="index.php">
        ...
        <div class="row justify-content-center">
            <div class="col-12 table-responsive">
                <table class="table  table-hover table-striped">
                    ...
                    foreach ($products as $pro) :
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="restore.php?id=<?php echo $pro['id'];?>" onclick="return confirm('Are you sure you want to restore?')">Restore</a>
                            </td>
                        </tr>
                    <?php
                    endforeach;
                    ...
                    ?>
                        <tr>
                            <td colspan="2"> No Trash Product is Available. <a href="index.php">Click here to trash one</a></td>
                        </tr>
                    <?php
                    endif;
                    ?>
